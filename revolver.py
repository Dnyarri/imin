...
in01 = Spinbox(frame_top, from_=-90.0, to=90.0, increment=1, textvariable=ini_x, format='%2.1f', state='disabled', width=4, font=('helvetica', 11), validate='key', validatecommand=(validate_entry, '%S'))
