...
"""Barycentric image interpolation and rescaling in pure Python.
...
- **``baryc``**: reading single pixel from image 3D list at float (x, y) coordinates,
interpolated using barycentric coordinate system;
